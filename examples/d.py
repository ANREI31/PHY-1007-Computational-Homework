...
if __name__ == "__main__":
    ...
    wires = [
        ...
        Wire(start=(46, 31), stop=(36, 31), current=Current(x=-1, y=0), voltage=4.5),
        Wire(start=(36, 31), stop=(36, 36), current=Current(x=0, y=1), voltage=4.5),
        Wire(start=(36, 36), stop=(31, 36), current=Current(x=-1, y=0), voltage=4.5),
        Wire(start=(31, 36), stop=(31, 41), current=Current(x=0, y=1), voltage=4.5),
        Wire(start=(31, 41), stop=(16, 41), current=Current(x=-1, y=0), voltage=4.5),
        Wire(start=(16, 41), stop=(16, 31), current=Current(x=0, y=-1), voltage=4.5),
        Wire(start=(16, 31), stop=(21, 31), current=Current(x=1, y=0), voltage=4.5),
        Wire(start=(21, 31), stop=(21, 26), current=Current(x=0, y=-1), voltage=4.5),
        Wire(start=(21, 26), stop=(26, 26), current=Current(x=1, y=0), voltage=4.5),
        Wire(start=(26, 26), stop=(26, 21), current=Current(x=0, y=-1), voltage=4.5),
        Wire(start=(26, 21), stop=(46, 21), current=Current(x=1, y=0), voltage=4.5),
